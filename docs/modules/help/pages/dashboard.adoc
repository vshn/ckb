...
The Dashboard is the main screen of the https://control.vshn.net[Customer Portal]. It offers a quick navigation mechanism across all functional areas.

.The Customer Portal dashboard
image::dashboard.png[]

<1> The menu on the left side provides quick access to major sections of the Customer Portal.
...
.The Customer Portal on a mobile device
