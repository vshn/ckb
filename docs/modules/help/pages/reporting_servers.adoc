...
. Select one of the servers from the list, by clicking on its domain name. This will take you to the menu:Server Management[] section of the Customer Portal.
...
[start=4]
. Click on the btn:[Report] link to go back to the menu:Reporting[Servers] screen of the Customer Portal. You will see the facts you selected previously, for all servers on a table. You can export the contents of the report to a CSV or Excel file by clicking the corresponding buttons next to the search field.
