...
IMPORTANT: Please enter all information in the ticket in English, as some VSHNeers don't speak German.
...
. Indicate the servers affected by this issue in the **Affects** field, if applicable.
