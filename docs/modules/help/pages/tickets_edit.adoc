...
One of the most common uses of the Customer Portal consists in the creation of new tickets. You can access the ticket creation form from various parts of the user interface.
